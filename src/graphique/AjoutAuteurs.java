...
public class Test1 {
	...
	String sql ="If Not Exists(select * from Auteurs where (nom,prenom,dateNaissance,dateDeces)='"+ nom.getText()+prenom.getText()
	+dateNaissance.getText()+ dateDeces.getText() +"' insert into Auteurs (nom,prenom,dateNaissance,dateDeces)"
			+ "values ('" + nom.getText() + "','"
		...
		/*if (sql ) {
			   JOptionPane.showMessageDialog(null, "Auteurs existant", "Erreur Auteur existant"
