...
public class Gérant {
	...
	private void initialize() {
		...
		btnNewButton_2.setIcon(new ImageIcon("C:\\Users\\kadir\\Downloads\\delete_delete_deleteusers_delete_male_user_maleclient_2348.png"));
		btnNewButton_2.setBounds(316, 242, 123, 45);
		panel.add(btnNewButton_2);
		
		JButton btnEnvoyerUnMessage = new JButton("Envoyer");
		btnEnvoyerUnMessage.setIcon(new ImageIcon("C:\\Users\\kadir\\Downloads\\1904660-email-envelope-letter-mail-message-post-send_122510.png"));
